...
const Home = () => {
  ...
  const categories = [
    { name: "Pets (Adoption)", icon: "🐶", count: 24, color: "from-blue-500 to-cyan-400" },
    { name: "Pet Food", icon: "🍖", count: 56, color: "from-green-500 to-emerald-400" },
    { name: "Accessories", icon: "🧸", count: 42, color: "from-purple-500 to-pink-400" },
    { name: "Pet Care Products", icon: "💊", count: 18, color: "from-red-500 to-orange-400" }
  ];

  const petHeroes = [
    { name: "Sarah Johnson", pet: "Rescued 15 dogs", image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" },
    { name: "Michael Chen", pet: "Adopted 3 cats", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" },
    { name: "Emma Wilson", pet: "Foster caregiver", image: "https://images.unsplash.com/photo-1494790108755-2616b612b786?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" },
    { name: "David Park", pet: "Volunteer at shelter", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" }
  ];
        ...
        <div className="container mx-auto px-4 py-24 relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              <Typewriter
                words={['Find Your Furry Friend Today!', 'Adopt, Don\'t Shop', 'Every Pet Deserves Love']}
                loop={true}
                cursor
                cursorStyle="|"
                typeSpeed={70}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Every adoption means one less animal in a shelter and one more life saved.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Adopted pets are often vaccinated, spayed/neutered, and ready for their forever homes.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Join our community of responsible pet owners and get ongoing support and advice.
                    </p>
                  </div>
                </div>
              </motion.div>
            ...
            >
              ...
              <div className="absolute -bottom-4 -right-4 bg-white dark:bg-gray-800 p-4 rounded-2xl shadow-lg">
                ...
                <p className="text-gray-600 dark:text-gray-300">- Happy Adopter</p>
              </div>
            </motion.div>
          </div>
        </div>
            ...
            {petHeroes.map((hero, index) => (
              ...
              >
                ...
                <div className="p-6 text-center">
                  ...
                  <p className="text-purple-600 font-semibold mb-2">{hero.pet}</p>
